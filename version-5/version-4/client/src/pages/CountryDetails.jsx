...
function CountryDetails({ allCountriesData }) {
  ...
  // Find the selected country's details from the 'allcountriesdata' prop
  const foundCountry = allCountriesData?.find((item) => item.name.common === countryName);
